...
/* dropdown-menus.twig */
class __TwigTemplate_f2100d757f03dd648270f439584e273f6dda9c154edc91022c3e5daf3237cbae extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["menu_key"] => $context["menu"]) {
            ...
            if (($context["menu_key"] == ($context["slug"] ?? null))) {
                ...
                // line 7
                echo "        ";
            } elseif (twig_in_filter($this->getAttribute($context["menu"], "slug", array()), twig_get_array_keys_filter($this->getAttribute(($context["settings"] ?? null), "menus", array())))) {
                // line 8
                echo "            ";
            ...
            // line 12
            echo "        <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($context["menu"], "slug", array()), "html", null, true);
            echo "\"";
...
", "dropdown-menus.twig", "/Users/bluepixel/Sites/besteel/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/dropdown-menus.twig");
    }
}
