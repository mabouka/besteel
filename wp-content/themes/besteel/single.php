    ...
    <section class="photoText">
        <div class="wrapper wrapper--big">
            ...
            <div class="photoText__text content">
                ...
                <?php if (get_field('photoText_array')): ?>
                    <table class="photoText__array">
                        <thead>
                            <tr>
                                <th class="photoText__array__title"><?php _e('Gamme de Produits','blue'); ?></th>
                                <th class="photoText__array__title"><?php _e('Gamme Epaisseurs','blue'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php foreach (get_field('photoText_array') as $key => $line): ?>
                            <tr class="photoText__array__line <?php if($key % 2 == 0): ?> photoText__array__line--odd <?php endif; ?>">
                                <td class="photoText__array__data"><?php echo($line['product']); ?></td>
                                <td class="photoText__array__data"><?php echo($line['thickness']); ?></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
